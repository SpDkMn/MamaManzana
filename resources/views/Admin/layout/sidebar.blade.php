...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview @if(Request::is('admin/orders') || Request::is('admin/orders-status'))active @endif">
        <a href="#">
        ...
        <ul class="treeview-menu">
          <li @if(Request::is('admin/orders') ) class="active" @endif>
            <a href="route('admin_orders_path')"><i class="fa fa-circle-o"></i> Pedidos</a>
          </li>
          <li @if(Request::is('admin/orders-status') ) class="active" @endif>
            <a href="route('admin_orders-status_path')"><i class="fa fa-circle-o"></i> Estado de pedidos</a>
          </li>
        </ul>
      </li>
      ...
      <li class="treeview @if(Request::is('admin/categories') || Request::is('admin/products')) active @endif">
        ...
        <ul class="treeview-menu">
          <li @if(Request::is('admin/categories')) class="active" @endif>
            <a href="{{ route('admin_categories_path') }}"><i class="fa fa-circle-o"></i> Categorias</a>
          </li>
          <li @if(Request::is('admin/products')) class="active" @endif>
            <a href="{{route('admin_products_path')}}"><i class="fa fa-circle-o"></i> Productos</a>
          </li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="{{route('admin_zones_path')}}"><i class="fa fa-circle-o"></i> Zonas</a></li>
          <li>
      ...
      <li class="treeview @if(Request::is('admin/about-us') || Request::is('admin/contact-information') || Request::is('admin/menu') || Request::is('admin/settings')|| Request::is('admin/social-network')) active @endif">
        <a href="#">
        ...
        <ul class="treeview-menu">
          <li @if(Request::is('admin/settings')) class="active" @endif>
            <a href="{{ route('admin_settings_path') }}"><i class="fa fa-circle-o"></i> Configuraciones</a>
          </li>
          <li @if(Request::is('admin/about-us')) class="active" @endif>
            <a href="{{ route('admin_about-us_path') }}"><i class="fa fa-circle-o"></i> Acerca de nosotros</a>
          </li>
          <li @if(Request::is('admin/contact-information')) class="active" @endif>
            <a href="{{ route('admin_contact-information_path')}}"><i class="fa fa-circle-o"></i> Información de contacto</a>
          </li>
          <li @if(Request::is('admin/social-network')) class="active" @endif>
            <a href="{{ route('admin_social-network_path')}}"><i class="fa fa-circle-o"></i> Redes Sociales</a>
          </li>
          <!--li @if(Request::is('admin/menu')) class="active" @endif>
            <a href="{{ route('admin_menu_path') }}"><i class="fa fa-circle-o"></i> Menu</a>
          </li-->
        </ul>
      </li>
    </ul>
